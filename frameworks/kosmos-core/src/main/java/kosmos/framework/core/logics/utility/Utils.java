...
public interface Utils {
	...
	/** for StringUtils */
	interface StringScope extends Utils {
		/** カラム名の区切り文字 */
	...
	/** for ObjectUtils */
	interface ObjectScope extends Utils {
		/** 行セパレータ */
	...
	/** for DateUtils */
	interface DateScope extends Utils {
		/** 固定日付 */
	...
	/** for BigDecimalScope */
	interface BigDecimalScope extends Utils {
		interface Formats {
			/** 数値(カンマ無し) */
	...
	interface SpecialScope extends Utils {
		enum Formats {
			/** 郵便番号 */
			PostalCode,
			/** 電話番号 */
