...
public class ConsecutiveQuery {
	...
	public List<List<Object>> getResultLists(Object... queries){
		...
		for(Object q : queries){
			if( q instanceof AbstractAdvancedOrmQuery ){
				OrmQuery<Object> delegate = ((AbstractAdvancedOrmQuery<Object>)q).getDelegate();
				...
				throw new UnsupportedOperationException("query must be a AbstractAdvancedOrmQuery or AbstractNativeQuery");
			}
		}
