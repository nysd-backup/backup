...
import static core.logics.utility.DateUtils.format;
import static core.logics.utility.DateUtils.parse;
...
public class Calculator {
	...
	public String getSysDate() {
		return format(getSystemDateTime(), Scopes.DateScope.Formats.DEFAULT_FORMAT);
	}
	...
	public String getSysDateTime() {
		return format(getSystemDateTime(), Scopes.DateScope.Formats.DATETIME_LONG_SECOND_FORMAT);
	}
	...
	public String getSysDateTimeHm() {
		return format(getSystemDateTime(), Scopes.DateScope.Formats.HOUR_MIN_FORMAT);
	}
	...
	public String getSysDateTimeShortSec() {
		return format(getSystemDateTime(), Scopes.DateScope.Formats.DATETIME_SHORT_SECOND_FORMAT);
	}
	...
	public String getHHMMTimeBeforeOneSec() {
		return DateUtils.format(getDateTimeBeforeOneSec(), Scopes.DateScope.Formats.HOUR_MIN_FORMAT);
	}
