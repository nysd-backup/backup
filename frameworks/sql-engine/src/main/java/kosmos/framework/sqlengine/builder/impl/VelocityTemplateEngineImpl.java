...
public class VelocityTemplateEngineImpl implements TemplateEngine{
	...
	/**
	 * @see kosmos.framework.sqlengine.builder.TemplateEngine#load(java.io.InputStream)
	 */
	@Override
	...
	/**
	 * @see kosmos.framework.sqlengine.builder.TemplateEngine#evaluate(java.lang.String, java.util.Map)
	 */
	@Override
