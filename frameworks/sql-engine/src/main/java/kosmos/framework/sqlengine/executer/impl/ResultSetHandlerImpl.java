...
public class ResultSetHandlerImpl implements ResultSetHandler{
	...
	/**
	 * @see kosmos.framework.sqlengine.executer.ResultSetHandler#getResultList(java.sql.ResultSet, java.lang.Class, kosmos.framework.sqlengine.executer.RecordFilter, int)
	 */
	@Override
