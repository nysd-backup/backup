...
public class TypeConverterImpl implements TypeConverter{
	...
	/**
	 * @see sqlengine.executer.TypeConverter#getParameter(java.lang.Class, java.sql.ResultSet, java.lang.String)
	 */
	@Override
	...
	/**
	 * @see sqlengine.executer.TypeConverter#setParameter(int, java.lang.Object, java.sql.PreparedStatement)
	 */
	@Override
