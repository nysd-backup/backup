...
public class ResultMapRecordHandlerImpl implements RecordHandler{
	 ...
	 */
	public ResultMapRecordHandlerImpl(Class<? extends Map> type , Map<String,Class<?>> typeMap,String[] labels, String[] javaLabels, TypeConverter converter){
		this.labels = labels;
	...
	/**
	 * @see sqlengine.executer.RecordHandler#getRecord(java.sql.ResultSet)
	 */
