...
import alpha.framework.advice.InvocationAdapterImpl;
import alpha.framework.registry.EJBComponentFinder;
import alpha.framework.registry.ServiceLocator;
import alpha.framework.transaction.AbstractTxInterceptor;
...
public class ConsecutiveTxInterceptor extends AbstractTxInterceptor{
	...
	/**
	 * @see alpha.framework.transaction.AbstractTxInterceptor#invokeRoot(javax.interceptor.InvocationContext)
	 */
	@Override
	protected Object invokeRoot(InvocationContext ic) throws Throwable {
		TransactionContext context = createServiceContext();
		try{		
			context.initialize();		
	...
	/**
	 * @see alpha.framework.transaction.AbstractTxInterceptor#invoke(javax.interceptor.InvocationContext)
	 */
	@Override
