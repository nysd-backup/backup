...
import org.coder.alpha.framework.transaction.consecutive.ConsecutiveTxInterceptor;
...
public class AutonomousTxInterceptor extends ConsecutiveTxInterceptor {
	...
	/**
	 * @see org.coder.alpha.framework.transaction.consecutive.ConsecutiveTxInterceptor#invoke(javax.interceptor.InvocationContext)
	 */
	@Override
	...
	/**
	 * @see org.coder.alpha.framework.transaction.consecutive.ConsecutiveTxInterceptor#createServiceContext()
	 */
	@Override
