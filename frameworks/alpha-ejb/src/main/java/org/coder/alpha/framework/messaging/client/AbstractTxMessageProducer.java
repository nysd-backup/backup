...
import org.coder.alpha.framework.messaging.client.AbstractMessageProducer;
import org.coder.alpha.framework.messaging.client.JMSUtils;
...
public abstract class AbstractTxMessageProducer extends AbstractMessageProducer{
	...
	/**
	 * @see org.coder.alpha.framework.messaging.client.AbstractMessageProducer#invoke(java.io.Serializable, java.lang.String)
	 */
	@Override
