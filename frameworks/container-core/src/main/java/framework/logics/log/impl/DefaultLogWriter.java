...
public class DefaultLogWriter implements LogWriter {
	 ...
	 * @param clazz カテゴリ
	 */
	public DefaultLogWriter(Class<?> clazz) {
		logger = Logger.getLogger(clazz);
		perf = Logger.getLogger("PERF:" + clazz.getName());
		access = Logger.getLogger("ACCESS:" + clazz.getName());
	}
