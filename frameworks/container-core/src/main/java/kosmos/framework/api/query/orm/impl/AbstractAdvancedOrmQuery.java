...
import kosmos.framework.api.query.orm.AdvancedOrmQuery;
...
public abstract class AbstractAdvancedOrmQuery<T> implements AdvancedOrmQuery<T>{
	...
	/**
	 * @see kosmos.framework.api.query.orm.AdvancedOrmQuery#setPessimisticReadNoWait()
	 */
	@Override
	...
	/**
	 * @see kosmos.framework.api.query.orm.AdvancedOrmQuery#setHint(java.lang.String, java.lang.Object)
	 */
	@Override
	...
	/**
	 * @see kosmos.framework.api.query.orm.AdvancedOrmQuery#setLockMode(javax.persistence.LockModeType)
	 */
	@Override
	...
	/**
	 * @see kosmos.framework.api.query.orm.AdvancedOrmQuery#find(java.lang.Object[])
	 */
	@Override
	...
	/**
	 * @see kosmos.framework.api.query.orm.AdvancedOrmQuery#exists(java.lang.Object[])
	 */
	@Override
	...
	/**
	 * @see kosmos.framework.api.query.orm.AdvancedOrmQuery#setCondition(kosmos.framework.sqlclient.api.orm.OrmCondition)
	 */
	@Override
