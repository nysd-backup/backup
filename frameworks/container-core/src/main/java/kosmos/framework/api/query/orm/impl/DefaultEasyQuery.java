...
import kosmos.framework.api.query.orm.impl.AbstractAdvancedOrmQuery;
...
public class DefaultEasyQuery<T> extends AbstractAdvancedOrmQuery<T> implements EasyQuery<T>{
	...
	/**
	 * @see kosmos.framework.api.query.orm.EasyQuery#filter(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see kosmos.framework.api.query.orm.EasyQuery#order(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see kosmos.framework.api.query.orm.EasyQuery#list(java.lang.Object[])
	 */
	@Override
	...
	/**
	 * @see kosmos.framework.api.query.orm.EasyQuery#single(java.lang.Object[])
	 */
	@Override
	...
	/**
	 * @see kosmos.framework.api.query.orm.EasyQuery#findAny(java.lang.Object[])
	 */
	@Override
	...
	/**
	 * @see kosmos.framework.api.query.orm.EasyQuery#existsByAny(java.lang.Object[])
	 */
	@Override
	...
	/**
	 * @see kosmos.framework.api.query.orm.EasyQuery#existsByList(java.lang.Object[])
	 */
	@Override
