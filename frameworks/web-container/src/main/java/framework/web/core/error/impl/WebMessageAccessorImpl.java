 ...
 */
package framework.web.core.error.impl;
...
public class WebMessageAccessorImpl implements MessageAccessor<MessageBean> {
	...
	/**
	 * @see framework.api.message.MessageAccessor#createMessage(int, java.lang.Object[])
	 */
	@Override
	...
	/**
	 * @see framework.api.message.MessageAccessor#addMessage(framework.api.message.MessageBean)
	 */
	@Override
