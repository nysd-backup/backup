...
import kosmos.framework.client.core.api.query.WebNativeQueryEngine;
...
public class PagingContextImpl implements PagingContext {
	...
	/**
	 * @see kosmos.framework.client.core.api.query.paging.PagingContext#getCurrentPageData()
	 */
	@Override
	...
	/**
	 * @see kosmos.framework.client.core.api.query.paging.PagingContext#getTotalCount()
	 */
	@Override
	...
	/**
	 * @see kosmos.framework.client.core.api.query.paging.PagingContext#getTotalPage()
	 */
	@Override
	...
	/**
	 * @see kosmos.framework.client.core.api.query.paging.PagingContext#getCurrentPageNo()
	 */
	@Override
	...
	/**
	 * @see kosmos.framework.client.core.api.query.paging.PagingContext#prepare(kosmos.framework.sqlclient.api.free.AbstractNativeQuery, int)
	 */
	@Override
	...
	/**
	 * @see kosmos.framework.client.core.api.query.paging.PagingContext#getPageData(int)
	 */
	@Override
