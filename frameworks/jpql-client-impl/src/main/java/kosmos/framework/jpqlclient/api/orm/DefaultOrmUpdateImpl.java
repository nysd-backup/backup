...
public class DefaultOrmUpdateImpl<T> implements JPAOrmUpdate<T>{
	...
	/**
	 * @see kosmos.framework.jpqlclient.api.orm.JPAOrmUpdate#setHint(java.lang.String, java.lang.Object)
	 */
	@Override
	...
	/**
	 * @see kosmos.framework.jpqlclient.api.orm.JPAOrmUpdate#setCondition(kosmos.framework.jpqlclient.api.orm.JPAOrmCondition)
	 */
	@Override
