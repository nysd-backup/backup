...
import kosmos.framework.sqlclient.api.wrapper.orm.OrmQueryWrapper;
...
public abstract class AbstractOrmQueryWrapper<T> implements OrmQueryWrapper<T>{
	...
	/**
	 * @see kosmos.framework.sqlclient.api.wrapper.orm.OrmQueryWrapper#getCurrentParams()
	 */
	@Override
	...
	/**
	 * @see kosmos.framework.sqlclient.api.wrapper.orm.OrmQueryWrapper#setHint(java.lang.String, java.lang.Object)
	 */
	@Override
	...
	/**
	 * @see kosmos.framework.sqlclient.api.wrapper.orm.OrmQueryWrapper#setLockMode(javax.persistence.LockModeType)
	 */
	@Override
	...
	/**
	 * @see kosmos.framework.sqlclient.api.wrapper.orm.OrmQueryWrapper#find(java.lang.Object[])
	 */
	@Override
	...
	/**
	 * @see kosmos.framework.sqlclient.api.wrapper.orm.OrmQueryWrapper#setCondition(kosmos.framework.sqlclient.api.orm.OrmQueryParameter)
	 */
	@Override
