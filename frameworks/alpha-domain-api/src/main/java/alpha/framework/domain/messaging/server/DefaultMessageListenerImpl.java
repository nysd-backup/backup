...
public class DefaultMessageListenerImpl implements MessageListener{
	...
	public void onMessage(Message arg0) {
		...
		FaultLogger notifier = ServiceLocator.createDefaultFaultNotifier();		
		try{
			invoke(arg0);	
		} catch (Throwable e) {
	 ...
	 */
	protected void handleThrowable(Throwable e,FaultLogger notifier){
	 ...
	 * @param notifier the notifier
	 */
	protected void notifyException(Throwable t ,FaultLogger notifier){		
