 ...
 * 
 * <pre>
 * 例:jms/org/xxx/alpha.framework.core/alpha.domain
 * </pre>
 *
 * @author yoshida-n
...
public class DestinationNameResolverImpl implements DestinationNameResolver{
	...
	/**
	 * @see alpha.framework.domain.messaging.client.DestinationNameResolver#createDestinationName(java.lang.reflect.Method, java.io.Serializable[])
	 */
	@Override
