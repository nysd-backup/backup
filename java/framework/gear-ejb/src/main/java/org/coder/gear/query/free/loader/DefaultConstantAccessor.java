...
public class DefaultConstantAccessor implements ConstantAccessor {
	...
	/**
	 * @see org.coder.gear.query.free.loader.ConstantAccessor#getConstTarget(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see org.coder.gear.query.free.loader.ConstantAccessor#isValidKey(java.lang.String)
	 */
	@Override
