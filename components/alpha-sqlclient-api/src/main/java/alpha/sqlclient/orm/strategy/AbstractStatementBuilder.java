...
import alpha.sqlclient.orm.SortKey;
...
public abstract class AbstractStatementBuilder implements SQLStatementBuilder{
	...
	/**
	 * @see alpha.sqlclient.orm.strategy.SQLStatementBuilder#createSelect(alpha.sqlclient.orm.CriteriaReadQueryParameter)
	 */
	@Override
	...
	/**
	 * @see alpha.sqlclient.orm.strategy.SQLStatementBuilder#createUpdate(java.lang.Class, java.lang.String, java.lang.String, java.util.List, java.util.Collection)
	 */
	@Override
