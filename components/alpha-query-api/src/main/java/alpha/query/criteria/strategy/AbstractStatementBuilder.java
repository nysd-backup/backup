 ...
 */
public abstract class AbstractStatementBuilder implements QueryStatementBuilder{
	
	protected StringBuilder query = new StringBuilder();
	
	/**
	 * @see alpha.query.criteria.strategy.QueryStatementBuilder#withSet(java.util.Map)
	 */
	@Override
	...
	/**
	 * @see alpha.query.criteria.strategy.QueryStatementBuilder#withOrderBy(java.util.List)
	 */
	@Override
	public QueryStatementBuilder withOrderBy(List<SortKey> orderby ){	
	...
	/**
	 * @see alpha.query.criteria.strategy.QueryStatementBuilder#withWhere(java.util.List)
	 */
	@Override
	public QueryStatementBuilder withWhere(List<Criteria<?>> wheres){		
	...
	/**
	 * @see alpha.query.criteria.strategy.QueryStatementBuilder#build()
	 */
	@Override
	public String build() {
