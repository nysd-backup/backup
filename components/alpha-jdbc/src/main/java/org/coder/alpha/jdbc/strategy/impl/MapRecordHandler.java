 ...
 */
public class MapRecordHandler implements RecordHandler{
	 ...
	 */
	public MapRecordHandler(Class<?> resultType , String[] labels, String[] javaLabels, TypeConverter converter){
		this.labels = labels;
