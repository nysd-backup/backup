...
public class StatementProviderImpl implements StatementProvider{
	...
	/**
	 * @see sqlengine.strategy.StatementProvider#createStatement(java.lang.String, java.sql.Connection, java.lang.String, int, int, int)
	 */
	@Override
	...
	/**
	 * @see sqlengine.strategy.StatementProvider#setParameter(java.sql.PreparedStatement, java.util.List)
	 */
	@Override
	...
	/**
	 * @see sqlengine.strategy.StatementProvider#setBatchParameter(java.sql.PreparedStatement, java.util.List)
	 */
	@Override
