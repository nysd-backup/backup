...
public class TypeConverterImpl implements TypeConverter{
	...
	/**
	 * @see alpha.jdbc.strategy.TypeConverter#getParameter(java.lang.Class, java.sql.ResultSet, java.lang.String)
	 */
	@Override
	...
	/**
	 * @see alpha.jdbc.strategy.TypeConverter#setParameter(int, java.lang.Object, java.sql.PreparedStatement)
	 */
	@Override
