...
public class EclipseLinkNativeGateway implements PersistenceGateway {
	...
	/**
	 * @see alpha.query.elink.free.gateway.PersistenceGateway#count()
	 */
	@Override
	...
	/**
	 * @see alpha.query.elink.free.gateway.PersistenceGateway#executeUpdate()
	 */
	@Override
	...
	protected PreparedQuery prepare(Conditions param){
		...
		return loader.prepare(str, Arrays.asList(param.getParam()),param.getWrappingClause(),param.getQueryId());			
	}
