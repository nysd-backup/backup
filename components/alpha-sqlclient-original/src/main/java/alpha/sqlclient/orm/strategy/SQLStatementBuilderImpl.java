...
public class SQLStatementBuilderImpl extends AbstractStatementBuilder{
	...
	/**
	 * @see alpha.sqlclient.orm.strategy.AbstractStatementBuilder#afterCreateSelect(java.lang.StringBuilder, alpha.sqlclient.orm.CriteriaReadQueryParameter)
	 */
	@Override
	...
	/**
	 * @see alpha.sqlclient.orm.strategy.AbstractStatementBuilder#createPrefix(java.lang.Class)
	 */
	@Override
	...
	/**
	 * @see alpha.sqlclient.orm.strategy.AbstractStatementBuilder#createUpdatePrefix(java.lang.Class)
	 */
	@Override
	...
	/**
	 * @see alpha.sqlclient.orm.strategy.SQLStatementBuilder#createInsert(java.lang.Class, java.util.Collection)
	 */
	@Override
	...
	/**
	 * @see alpha.sqlclient.orm.strategy.SQLStatementBuilder#createDelete(java.lang.Class, java.lang.String, java.util.List)
	 */
	@Override
