...
public class NativeGateway implements PersistenceGateway{
	...
	/**
	 * @see alpha.query.free.gateway.PersistenceGateway#getTotalResult(alpha.query.free.ReadingConditions)
	 */
	@Override
	...
	/**
	 * @see alpha.query.free.gateway.PersistenceGateway#getFetchResult(alpha.query.free.ReadingConditions)
	 */
	@Override
	...
	/**
	 * @see alpha.query.free.gateway.PersistenceGateway#count()
	 */
	@Override
	...
	/**
	 * @see alpha.query.free.gateway.PersistenceGateway#getResultList()
	 */
	@Override
	...
	/**
	 * @see alpha.query.free.gateway.PersistenceGateway#getSingleResult()
	 */
	@Override
	...
	/**
	 * @see alpha.query.free.gateway.PersistenceGateway#executeUpdate()
	 */
	@Override
	...
	/**
	 * @see alpha.query.free.gateway.PersistenceGateway#executeBatch(java.util.List)
	 */
	@Override
