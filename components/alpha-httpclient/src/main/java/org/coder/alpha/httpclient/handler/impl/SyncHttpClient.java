...
public class SyncHttpClient extends AbstractHttpInvocation {
	...
	/**
	 * @see org.coder.alpha.httpclient.handler.AbstractHttpInvocation#createConnectionManager(org.coder.alpha.httpclient.config.RequestProperty, org.apache.http.conn.scheme.SchemeRegistry)
	 */
