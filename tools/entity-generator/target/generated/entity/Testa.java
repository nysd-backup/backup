...
@Entity
@Table(name="TESTA")
public class Testa extends AbstractEntity {

	/** serialVersionUID */
	private static final long serialVersionUID = 1L;
	
	/** TEST */
	public static final Metadata<Testa, java.lang.String> TEST = new Metadata<Testa, java.lang.String>("TEST");
	
	/** ATTR */
	public static final Metadata<Testa, java.lang.String> ATTR = new Metadata<Testa, java.lang.String>("ATTR");
	
	/** ATTR2 */
	public static final Metadata<Testa, java.lang.Long> ATTR2 = new Metadata<Testa, java.lang.Long>("ATTR2");
	
	/** VERSION */
	public static final Metadata<Testa, java.lang.Long> VERSION = new Metadata<Testa, java.lang.Long>("VERSION");
