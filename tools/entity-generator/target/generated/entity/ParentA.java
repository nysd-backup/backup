...
public class ParentA extends AbstractEntity {
	...
	/** TEST */
	public static final Metadata<ParentA, java.lang.String> TEST = new Metadata<ParentA, java.lang.String>("TEST");
	
	/** ATTR2 */
	public static final Metadata<ParentA, java.lang.Long> ATTR2 = new Metadata<ParentA, java.lang.Long>("ATTR2");
	
	/** VERSION */
	public static final Metadata<ParentA, java.lang.Long> VERSION = new Metadata<ParentA, java.lang.Long>("VERSION");
	
	/** ATTR */
	public static final Metadata<ParentA, java.lang.String> ATTR = new Metadata<ParentA, java.lang.String>("ATTR");
	 ...
	 */
	@Override
	public ParentA clone() {
		ParentA clone = new ParentA();
		clone.test = test;
		clone.attr2 = attr2;
