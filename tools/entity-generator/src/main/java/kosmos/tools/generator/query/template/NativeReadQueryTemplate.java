...
public class NativeReadQueryTemplate
{
  protected static String nl;
  public static synchronized NativeReadQueryTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    NativeReadQueryTemplate result = new NativeReadQueryTemplate();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_2 = ";" + NL + "" + NL + "import alpha.framework.sqlclient.free.AbstractNativeReadQuery;" + NL + "" + NL + "/**" + NL + " * Query Entity of ";
  ...
  protected final String TEXT_6 = " extends AbstractNativeReadQuery {" + NL;
