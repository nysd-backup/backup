...
public class NamedModifyQueryTemplate
{
  protected static String nl;
  public static synchronized NamedModifyQueryTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    NamedModifyQueryTemplate result = new NamedModifyQueryTemplate();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_2 = ";" + NL + "" + NL + "import alpha.framework.sqlclient.free.AbstractNamedModifyQuery;" + NL + "" + NL + "/**" + NL + " * Query Entity of ";
  ...
  protected final String TEXT_5 = " extends AbstractNamedModifyQuery {" + NL;
