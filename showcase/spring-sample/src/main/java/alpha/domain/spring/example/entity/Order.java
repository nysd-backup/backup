...
public class Order {
	...
	public static final Metadata<OrderDtl,String> CUSTOMER_CD = new Metadata<OrderDtl,String>("customerCd");
	
	public static final Metadata<OrderDtl,Date> ORDER_DT = new Metadata<OrderDtl,Date>("orderDt");
